...
def main():
    ...
    key1_bin = int(bin(int(key1, 16)).replace('0b', ''), 2)
    key2_bin = int(bin(int(key2, 16)).replace('0b', ''), 2)
    s_bin = '{:064b}'.format(s_bin)
    key1_bin = '{:064b}'.format(key1_bin)
    key2_bin = '{:064b}'.format(key2_bin)

    res = DES3(s_bin, key1_bin, key2_bin, m)
    print(res)
...
if __name__ == "__main__":
    ...
    graphviz.output_file = 'DES3.py.png'
